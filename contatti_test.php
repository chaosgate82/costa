...
<head>
<title>Dariocosta.eu - contacts | Aerobatic Flight Training</title>
...
<div class="wrapper" >
  ...
  <a href="profile.php"> <div class="item_menu"> <span class="red">p</span>rofile</div></a><a href="news.php"> <div class="item_menu"><span class="red">n</span>ews & <span class="red">m</span>edia</div></a><a href="publications.php"><div class="item_menu"><span class="red">p</span>ublications</div></a>
   <div class="item_menu spacer underlineRed"><span class="red">c</span>ontact</div></span><span class="red spacer">}</span></div>
    
    <img class="img_contatti" src="contatti.jpg" />
    
    
    <div class="text_contatti"> 
    
    For inquiries or to request additional information about Dario Costa:<br /><br />

<span class="red">P</span> (0039) 338 - 3403674<br /><br />

<span class="red">E</span> info@dariocosta.eu<br /><br />

<span class="red">Follow Dario Costa:</span><br />
    <div class="social_bar" style="float:left; margin-top:10px;"><a href="https://twitter.com/costadario1" target="_blank"><img src="tweet.jpg" width="33" height="28" alt="tweet" border="0" /></a><a href="http://www.facebook.com/costadario1?ref=ts&fref=ts"><img src="facebook.jpg" width="33" height="28" alt="facebook" border="0" /></a><a href="http://www.linkedin.com/in/dariocosta1" target="_blank"><img src="linkedin.jpg" width="32" height="28" alt="linkedin" border="0" /></a> </div>
    </div>
   
   <div style="width:770px;float:left;clear:both; margin:16px 0 0 0">
